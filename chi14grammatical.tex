...
\subfigure[The baseline condition]{
	\includegraphics[width=0.3\textwidth]{fig/baseline-choices}
    \label{fig:baseline-choices}
}
\subfigure[The matching-words condition]{
	\includegraphics[width=0.3\textwidth]{fig/words-choices}
    \label{fig:words-choices}
}
\subfigure[The matching-phrases condition ]{
	\includegraphics[width=0.3\textwidth]{fig/fragments-choices}
    \label{fig:phrases-choices}
}
